...
export class PauseMenu extends ex.Scene {
    ...
    this.menuItems = [
      {
        label: "Resume",
        action: (e) => {
          void e.goToScene("game-world");
        },
      },
      {
        label: "Save Game",
        action: (e) => {
          void e.goToScene("save-game");
        },
      },
      {
        label: "Load Game",
        action: (e) => {
          void e.goToScene("load-game", { sceneActivationData: { returnTo: "pause-menu" } });
        },
      },
      {
        label: "Settings",
        action: (e) => {
          void e.goToScene("settings", { sceneActivationData: { returnTo: "pause-menu" } });
        },
      },
      {
